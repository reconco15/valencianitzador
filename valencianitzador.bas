...
Sub Main
    ...
    'Lookbehind no alfa + verbs haver anar i veure
    postNs="(?=(n|s)([^[:alpha:]]|$))"
    'Lookahead noalfa + terminacions "n" i "s"
    postMu="(?=(m|u)([^[:alpha:]]|$))"
    'Lookahead noalfa + terminacions "m" i "u"
    postNsmu="(?=(n|s|m|u)([^[:alpha:]]|$))"
    'Lookahead noalfa + terminacions "n", "s", "m" i "u"
